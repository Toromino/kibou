...
fn get_ap_activity_by_id() {
    ...
    let result = activity::get_ap_activity_by_id(
        &database,
        "https://example.tld/activities/5b4f7e70-8467-44ef-8278-9729b5c11ba7",
    );
    activity::delete_ap_activity_by_id(
        &database,
        String::from("https://example.tld/activities/5b4f7e70-8467-44ef-8278-9729b5c11ba7"),
    );
...
fn get_ap_object_by_id() {
    let database = database::establish_connection();
    let test_object_id =
        String::from("https://remote.tld/objects/9c247a1d-5aed-4a3f-922d-d88eaf9938a2");
...
fn get_ap_object_replies_by_id() {
    let database = database::establish_connection();
    let test_object_id =
        String::from("https://remote.tld/objects/6d5fbaa1-82b6-434d-b885-7865b07deae4");
    let test_reply_id =
        String::from("https://remote.tld/objects/b7435596-e01d-4474-bbd5-b033149bddbf");
...
fn count_ap_object_replies_by_id() {
    let database = database::establish_connection();
    let test_object_id =
        String::from("https://remote.tld/objects/1c34ec09-a2dd-4d43-85b9-2c63cbbd1f54");
    let test_reply_id =
        String::from("https://remote.tld/objects/a0aa8551-f1a7-4b83-9493-9dadc378599b");
    ...
    let reply_num: usize =
        activity::count_ap_object_replies_by_id(&database, &test_object_id.clone())
            .unwrap_or_else(|_| 0);
    activity::delete_ap_object_by_id(&database, test_object_id);
    activity::delete_ap_object_by_id(&database, test_reply_id);
